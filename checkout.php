   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" name="flat" required placeholder="E.j Piso No.">
         </div>
         <div class="inputBox">
            <span>Línea de dirección 01 :</span>
         ...
         <div class="inputBox">
            <span>Provincia :</span>
            <input type="text" name="city" required placeholder="E.j Santiago">
         </div>
         <div class="inputBox">
            <span>Municipio :</span>
            <input type="text" name="state" required placeholder="E.j Santiago de los caballeros">
         </div>
         <div class="inputBox">
            <span>País :</span>
            <input type="text" name="country" required placeholder="E.j República Dominicana">
         </div>
         <div class="inputBox">
            <span>Código pin :</span>
            <input type="number" min="0" name="pin_code" required placeholder="E.j 123456">
         </div>
      </div>
